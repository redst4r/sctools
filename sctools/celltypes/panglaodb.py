...
# for some weird reason they define spec as the fraction of other cells
# that express the marker (i.e. 1==all other cells epxress teh marker)
...
def get_celltype_markers(sens, spec, list_of_organs):
    """
    extract all celltype markers from panglaodb for the given organ
    and sensitivities, specificities

    :param sens (float): Sensitivity of the markers
    :param spec (float): Specificity of the markers
    :param list_of_organs: all celltypes from these organs are returned
    """
